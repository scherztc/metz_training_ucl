...
1. `cd metz_training_ucl`
1. `rvm install ruby-2.3.3`
1. `rvm use ruby-2.3.3`
1. `gem install bundler`
1. `bundle install`
1. `git checkout start-of-bottles-tdd`
1. `ruby sanity_test.rb` (make sure tests pass)

---

# 99 Bottles of Beer on the Wall

Write code in `./bottles/lib/bottles.rb` that will output the lyrics to the song
_99 Bottles of Beer_.

### Test Suite

A failing test suite is provided in `./bottles/test/bottles_test.rb`.
...
```plain
$ ruby bottles/test/bottles_test.rb --name test_verse_1
```
